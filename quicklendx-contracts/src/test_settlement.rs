...
/// Test that get_settlement_batch_soft_cap returns the expected default value.
#[test]
fn test_get_settlement_batch_size_soft_cap_returns_default() {
    ...
    let batch_size = client.get_settlement_batch_soft_cap();
    assert_eq!(batch_size, 25, "Default settlement batch size soft cap should be 25");
}

/// Test that get_settlement_batch_max_cap returns the expected maximum value.
#[test]
fn test_get_settlement_batch_size_soft_cap_max_returns_maximum() {
    ...
    let max_batch_size = client.get_settlement_batch_max_cap();
...
fn test_settlement_batch_size_consistency_with_query_limit() {
    ...
    let max_batch_size = client.get_settlement_batch_max_cap();
    let default_batch_size = client.get_settlement_batch_soft_cap();
...
fn test_settlement_batch_size_stable_across_states() {
    ...
    let default_before = client.get_settlement_batch_soft_cap();
    let max_before = client.get_settlement_batch_max_cap();
    ...
    let default_after = client.get_settlement_batch_soft_cap();
    let max_after = client.get_settlement_batch_max_cap();
